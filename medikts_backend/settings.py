"""
Django settings for medikts_backend project.
...
ALLOWED_HOSTS = ['0.0.0.0', 'localhost', '127.0.0.1', 'immense-citadel-54815.herokuapp.com']
...
ROOT_URLCONF = 'medikts_backend.urls'
...
WSGI_APPLICATION = 'medikts_backend.wsgi.application'
